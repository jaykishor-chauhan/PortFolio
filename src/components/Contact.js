...
const Contact = () => {
  ...
  return (
    <section className="text-gray-600 body-font ">
      <div className="px-3 py-4 mx-auto text-center md:mt-7 sm:mx-7 md:mx-12 lg:mx-32 xl:mx-56">
        <div id="contact" className="flex flex-col text-center w-full mb-4">
          ...
          <div className="flex items-center justify-center">
            {/* Left Line */}
            <div className="border-t border-black" style={{ width: '0.4cm', borderTopWidth: '2.5px' }}></div>
        ...
        <div className="flex flex-col gap-2 md:flex-row w-full mx-auto rounded-xl bg-darkblue p-4 md:gap-7 lg:gap-9 lg:rounded-2xl xl:gap-10">
          <div className="p-2 w-full text-center lg:p-5 xl:p-7 md:w-1/2 lg:w-4/6">
            ...
            <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="false" className="flex gap-3 items-center mb-4 md:gap-2 lg:gap-5">
              ...
              <p className="text-white md:text-lg ">+977 9815215667</p>
            </div>
            <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="false" className="flex gap-3 items-center mb-4 md:gap-2 lg:gap-5">
              <FaEnvelope className="text-white" />
              <a href="mailto:talakolavijaykumar@gmail.com" className="text-white md:text-lg">jaykishor.04.3.7.np@gmail.com</a>
            </div>
            <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="false" className="flex gap-3 items-center md:gap-2 lg:gap-5">
              ...
              <p className="leading-normal text-start text-white md:text-lg">Birgunj , Madhesh Pradesh , Nepal</p>
            </div>
          </div>
