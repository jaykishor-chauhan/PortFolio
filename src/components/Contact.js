...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs.sendForm("service_g324hgs", "template_7agjzsi", formRef.current, "Oyt7L4olsIhVV1wD3")
      .then(
        (result) => {
  ...
  return (
    <section className="text-gray-600 body-font">
      <div id="contact" className="px-3 py-4 mx-auto text-center md:mt-7 sm:mx-7 md:mx-12 lg:mx-32 xl:mx-56">
        ...
        <div className="flex flex-col md:flex-row w-full bg-gradient-to-br from-blue-100 via-white to-orange-100 border border-gray-200 shadow-2xl rounded-2xl overflow-hidden">
          <div className="p-2 w-full text-center lg:p-5 xl:p-7 md:w-1/2 lg:w-4/6">
            <h1 data-aos="zoom-in-down" data-aos-duration="1000" data-aos-once="false" className="text-2xl lg:text-3xl font-semibold text-blue-900 mb-6">
              Get In Touch
            </h1>
            ...
            <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="false" className="flex gap-3 items-center mb-4 md:gap-2 lg:gap-5">
              ...
              <p className="text-blue-900 md:text-lg ">+977 9815215667</p>
            </div>
            <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="false" className="flex gap-3 items-center mb-4 md:gap-2 lg:gap-5">
              <FaEnvelope className="text-blue-900" />
              <a href="mailto:talakolavijaykumar@gmail.com" className="text-blue-900 md:text-lg">jaykishor.04.3.7.np@gmail.com</a>
            </div>
            <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="false" className="flex gap-3 items-center md:gap-2 lg:gap-5">
              ...
              <p className="leading-normal text-start text-blue-900 md:text-lg">Birgunj , Madhesh Pradesh , Nepal</p>
            </div>
          </div>
          <form data-aos="zoom-in-up" data-aos-duration="1000" data-aos-once="false" ref={formRef} onSubmit={handleSubmit} className="flex bg-gradient-to-br from-orange-100 via-white to-blue-100 flex-col p-2 rounded-lg md:w-1/2 md:p-4 lg:px-5 lg:py-7 lg:m-4 lg:w-3/5">
            ...
            <div data-aos="zoom-in" data-aos-duration="1500" data-aos-once="false" className="p-2 w-full">
              <button className=" font-medium mx-auto my-3 text-white bg-blue-600 border-0 py-2 px-12 focus:outline-none hover:scale-110 hover:bg-orange-500 transition duration-500 rounded-xl text-lg">
                Send
              </button>
            </div>
          </form>
